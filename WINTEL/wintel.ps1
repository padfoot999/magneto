...
getEventOfInterest -logfile "Security" -eventid 1102, 4616, 4624, 4625, 4634, 4647, 4648, 4656, 4658, 4660, 4663, 4672, 4673, 4688, 4689, 4697, 4720
getEventOfInterest -logfile "Security" -eventid 4732, 4738, 4768, 4769, 4771, 4776, 4778, 4779, 4800, 4801, 5142, 5156, 7036, 7045, 8222, 4722, 4724
...
getEventOfInterest -logfile "System" -eventid 10000,100001,10100,104,1056,20001,20002,24576,24577,24579,6100,7030,7034,7035,7036,7040,7045
...
getEventOfInterest -logfile "Application"  -eventid 1033,1034,11707,11708,11724,132,143,166,60,80
...
getEventOfInterestWithMsg -logfile "Security" -msg "psexec.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "WMIC.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "powershell.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "cscript.exe"
getEventOfInterestWithMsg -logfile "Application" -msg "Windows Remote Management"
getEventOfInterestWithMsg -logfile "Security" -msg "winrs.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "at.exe"
getEventOfInterestWithMsg -logfile "Application" -msg "Bits-Client"
getEventOfInterestWithMsg -logfile "Security" -msg "PwDump7.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "PWDumpX.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "QuarksPwDump.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "mimikatz.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "wce.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "Islsass"
getEventOfInterestWithMsg -logfile "Security" -msg "mailpv.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "WebBrowserPassView.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "rdpv.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "iexplore.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "mstsc.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "wceaux.dll"
getEventOfInterestWithMsg -logfile "Security" -msg "Process Executed with SYSTEM Privileges"
getEventOfInterestWithMsg -logfile "Security" -msg "sdbinst.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "ms14-068.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "ntdsutil.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "explorer.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "VSSVC.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "vssadmin.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "net.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "net1.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "lsass.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "icacls.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "sdelete.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "timestomp.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "wevtutil.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "csvde.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "ldifde.exe"
getEventOfInterestWithMsg -logfile "Security" -msg "dsquery.exe"
...
outputMsg -msg "PsExec" -eventid @(4688, 4689)
outputMsg -msg "WMIC" -eventid @(4688, 4689)
outputMsg -msg "PowerShell" -eventid @(4688, 4689, 5156)
outputMsg -msg "wmiexec.vbs" -eventid @(4688, 4689, 5156)
outputMsg -msg "BeginX" -eventid @(4688, 4689, 5156)
outputMsg -msg "WinRM" -eventid @(4688, 4689, 5156, 166, 80, 143, 132)
outputMsg -msg "WinRS" -eventid @(4688, 4689, 4648, 5156, 80)
outputMsg -msg "at" -eventid @(4688, 4689)
outputMsg -msg "BITS" -eventid @(4656, 4663, 4658, 7036, 60)
outputMsg -msg "PwDump7" -eventid @(4688, 4689)
outputMsg -msg "PWDumpX" -eventid @(4688, 4689, 4663)
outputMsg -msg "Quarks PwDump" -eventid @(4688, 4689, 4656, 4663, 4658, 4660)
outputMsg -msg "Mimikatz (Obtaining Password Hash)" -eventid @(4688, 4689)
outputMsg -msg "Mimikatz (Obtaining Ticket)" -eventid @(4688, 4689, 4656, 4663, 4658)
outputMsg -msg "WCE (Windows Credentials Editor)" -eventid @(4688, 4689, 4656, 4663, 4658, 4660)
outputMsg -msg "gsecdump" -eventid @(4688, 4689)
outputMsg -msg "lslsass" -eventid @(4688, 4689)
outputMsg -msg "Find-GPOPasswords.ps1" -eventid @(4688, 4689, 4656, 4663, 4658)
outputMsg -msg "Mail PassView" -eventid @(4688, 4689, 4663, 4656, 4658)
outputMsg -msg "WebBrowserPassView" -eventid @(4688, 4689, 4663, 4656, 4658)
outputMsg -msg "Remote Desktop PassView" -eventid @(4688, 4689, 4656, 4663, 4658)
outputMsg -msg "Htran" -eventid @(4688, 4689, 5156)
outputMsg -msg "Fake Wpad" -eventid @(5156, 4656, 4663, 4658)
outputMsg -msg "RDP (Remote Desktop Protocol)" -eventid @(4688, 4689, 4663, 4656, 4658)
outputMsg -msg "WCE (Remote Login)" -eventid @(4656, 4663, 4658, 4660, 5156, 7045, 7036, 7045, 7036)
outputMsg -msg "Mimikatz (Remote Login)" -eventid @(4688, 4689, 5156, 4648)
outputMsg -msg "MS14-058 Exploit" -eventid @(4688, 4689)
outputMsg -msg "MS15-078 Exploit" -eventid @(4688, 4689)
outputMsg -msg "SDB UAC Bypass" -eventid @(4688, 4689, 4656, 4663, 4658)
outputMsg -msg "MS14-068 Exploit" -eventid @(4688, 4689, 4673, 5156, 4656, 4663, 4658)
outputMsg -msg "Mimikatz (Golden Ticket)" -eventid @(4688, 4689, 4673, 4663, 4656, 4658)
outputMsg -msg "Mimikatz (Silver Ticket)" -eventid @(4688, 4689, 4673)
outputMsg -msg "ntdsutil" -eventid @(4688, 4689, 4673, 8222, 4656, 7036, 20001)
outputMsg -msg "vssadmin" -eventid @(4688, 4689, 8222, 7036, 20001)
outputMsg -msg "net user" -eventid @(4688, 4689, 4656, 4720)
outputMsg -msg "net use" -eventid @(4688, 4689, 5156)
outputMsg -msg "net share" -eventid @(4688, 4689, 5142)
outputMsg -msg "icacls" -eventid @(4688, 4689)
outputMsg -msg "sdelete" -eventid @(4688, 4689, 4656, 4663, 4658)
outputMsg -msg "timestomp" -eventid @(4688, 4689, 4656, 4663, 4658)
outputMsg -msg "wevtutil" -eventid @(4688, 4689, 4648)
outputMsg -msg "csvde" -eventid @(4688, 4689, 5156, 4663, 4656, 4658)
outputMsg -msg "ldfide" -eventid @(4688, 4689, 5156, 4656, 4663, 4658)
outputMsg -msg "dsquery" -eventid @(4688, 4689, 5156, 4663, 4656, 4658)