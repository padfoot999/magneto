...
sub pluginmain {
	...
	::rptMsg("usbstor v.".$VERSION); # banner
  	...
  	::rptMsg("//Identify unique USB device");
  	::rptMsg("//Note that device with a NON unique serial number will have an & in the 2nd char of the serial number");
  	::rptMsg("//Note that only MSC is required by Microsoft to have unique serial number!!!"."\n");
...
# http://studioshorts.com/blog/2012/10/windows-8-device-property-ids-device-enumeration-pnpobject/					
						...
						eval {
							my $t = $k->get_subkey("Properties\\{83da6326-97a6-4088-9453-a1923f573b29}\\0064");
							::rptMsg("    FirstConnected     : ".gmtime($t->get_timestamp()));

							$t = $k->get_subkey("Properties\\{83da6326-97a6-4088-9453-a1923f573b29}\\0065");
							::rptMsg("    LastConnected     : ".gmtime($t->get_timestamp()));

							$t = $k->get_subkey("Properties\\{83da6326-97a6-4088-9453-a1923f573b29}\\0067");
							::rptMsg("    LastRemoved     : ".gmtime($t->get_timestamp()));
							#$t = $k->get_subkey("Properties\\{83da6326-97a6-4088-9453-a1923f573b29}\\0065")->get_value("Data")->get_data();
							#($t0,$t1) = unpack("VV",$t);
